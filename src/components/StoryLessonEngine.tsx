    ...
    useEffect(() => {
        ...
        const buildOfflineLesson = (rawSubject: string): DialogueNode[] => {
            ...
            const nodes: DialogueNode[] = [
                ...
                { id: "off-3", characterName: "Professor Grace", text: `Let's talk about ${topic}. When we study ${subjectName}, understanding specific vocabulary is the key to unlocking bigger ideas. Every term connects to a core concept that helps us explain how things work.\n\nRead the letters below carefully. Think about what we're learning today, and tap the tiles in the correct order to reveal a crucial term. Let's build your foundation! 🔤`, voiceType: "professor", visualType: "science-atom", isQuiz: false, miniGame: "wordScramble", itemReward: null as any },
