...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-white font-sans flex flex-col relative overflow-x-hidden grain-overlay" style={{ fontFamily: 'Inter, Outfit, sans-serif' }}>
